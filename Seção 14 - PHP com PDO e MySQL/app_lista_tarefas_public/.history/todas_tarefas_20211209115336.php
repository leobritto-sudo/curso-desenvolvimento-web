								...
								<? foreach($tarefas as $key => $tarefa): ?>
									...
									<div class="row mb-3 d-flex align-items-center tarefa">
										...
										<div class="col-sm-3 mt-2 d-flex justify-content-between">
											<i class="fas fa-trash-alt fa-lg text-danger pe-auto" onclick="excluir(<?= $tarefa->id ?>)"></i>
											<i class="fas fa-edit fa-lg text-info pe-auto" onclick="editar(<?= $tarefa->id ?>, '<?= $tarefa->tarefa ?>')"></i>
